...
export async function postCommunity(post) {
  ...
  const res = await axios
    .post(`${baseURL}posts`, { ...post }, { headers })
    .then((res) => res.data)
...
export async function deleteCommunity(id) {
  ...
  const res = await axios
    .delete(`${baseURL}posts/${id}`, { headers })
    .then((res) => res.data)
    .catch((error) => error.response.data);
  return res;
}
...
export async function editCommunity(id, post) {
  ...
  const res = await axios
    .patch(`${baseURL}posts/${id}`, { ...post }, { headers })
    .then((res) => res.data)
    .catch((error) => error.response.data);
  return res;
}
...
export async function editType(id, type) {
  ...
  // console.log(headers);
  const res = await axios
    .patch(`${baseURL}posts/popular/${id}`, { type }, { headers })
    .then((res) => res.data)
    .catch((error) => error.response.data);
  return res;
}

...
import { deleteCommunity, editCommunity, editType, getCommunity, getCommunityById, getCrucials, postCommunity } from '../api/community';
...
export default function useCommunity() {
  ...
  const uptateType = useMutation({
	...
	return {communityQuery, crucialsQuery, addPost, deletePost, updatePost, uptateType};
}
